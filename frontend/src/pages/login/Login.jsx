      ...
      className=" w-full p-6 bg-brown-700 rounded-lg shadow-md bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-0 ">
        ...
        <form onSubmit={handleSubmit}>
          <div>
            ...
            <input type="text" placeholder="Enter Username" className="w-full input  hover:bg-white hover:text-black input-bordered bg-slate-800 text-white h-10" value={username} onChange={(e)=>setUsername(e.target.value)}/>
          </div>
          <div>
            <label className="label">
              <span className="text-gray-400 label-text">Password</span>
            </label>
            <input type="password" placeholder="Enter Password" className="w-full input  hover:bg-white hover:text-black input-bordered h-10  bg-slate-800  text-white" value={password} onChange={(e)=>setPassword(e.target.value)} />
          </div>
